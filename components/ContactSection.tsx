                    ...
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            <div className="flex gap-4 relative z-10">
                                {/* Instagram Button */}
                                <a
                                    href="https://www.instagram.com/zumfali.cosmetics"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-10 h-10 bg-white/20 rounded-full hover:bg-white hover:text-[#bb9c30] transition-all cursor-pointer flex items-center justify-center group"
                                    aria-label="Follow us on Instagram @zumfali.cosmetics"
                                >
