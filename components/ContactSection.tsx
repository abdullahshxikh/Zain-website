            ...
            <section className="py-20 bg-[#fafafa] border-t border-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-serif text-[#1a2f23] mb-4">Other Ways We Can Help</h2>
                        <p className="text-gray-500">Explore our resources to find what you need.</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            { title: 'Shipping Policy', icon: 'M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4', link: '#' },
                            { title: 'Returns & Exchanges', icon: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15', link: '#' },
                            { title: 'Track Your Order', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2', link: '#' },
                        ].map((item, i) => (
                            <Link key={i} href={item.link} className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all group flex flex-col items-center text-center border border-gray-100 hover:border-[#bb9c30]/30">
                                <div className="w-16 h-16 bg-[#1a2f23]/5 rounded-full flex items-center justify-center mb-6 group-hover:bg-[#1a2f23] transition-colors">
                                    <svg className="w-8 h-8 text-[#1a2f23] group-hover:text-[#bb9c30] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={item.icon} /></svg>
                                </div>
                                <h3 className="text-xl font-bold text-[#1a2f23] mb-2">{item.title}</h3>
                                <span className="text-[#bb9c30] text-sm font-bold uppercase tracking-wider group-hover:underline">Read More</span>
                            </Link>
                        ))}
                    </div>
                </div>
